...
The emg error, on the other hand, is a bit different at (-25,-2) and (-18,-2). Just as emg tries to adjust for scores with a *lot* of mwc at stakes, it also adjust for very *little* mwc at stake, thus magnifying small mwc's.
