...
Let's try to reproduce the "live" take points in the example position in the GNU Backgammon [manual](https://www.gnu.org/software/gnubg/manual/gnubg.pdf), section "Technical Notes|Equities explained".
...
The cubeless takepoints I calculate are as follows:
...
How about a simple example: Same score, no gammons. Trailer's takepoint:
...
We agree on the cubeless takepoints, but not on the live one, *when gammons are in play*. Why, oh, why is this?
