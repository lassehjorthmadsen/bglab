...
color_schemes <- list(
  "bw" = list(
    ...
    "top_checker_fill" = "white",
    "bottom_checker_fill" = "black",
    "top_checker_off_border" = "black",
    "bottom_checker_off_border" = "white",
    "board_fill" = "white",
    "board_border" = "black",
    "bar_fill" = "white"
    ),
  "soft" = list(
    ...
    "top_checker_fill" = "#f7fffc",
    "bottom_checker_fill" = "#010100",
    "top_checker_off_border" = "#010100",
    "bottom_checker_off_border" = "#f7fffc",
    "board_fill" = "#7dcde4",
    "board_border" = "#678a9a",
    "bar_fill" = "#c3e8f4"
    )
